<%-- 
    Document   : Mapping
    Created on : May 18, 2017, 9:30:27 AM
            ...
            <div class="nav-two navbar">
                <div class="container">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a  class="mdl-shadow--6dp" style="border: 1px solid #ddd;border-bottom-color: transparent;" href="Mapping.jsp">System Mapping</a></li>
                    </ul>
