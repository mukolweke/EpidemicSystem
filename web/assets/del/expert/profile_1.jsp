...
//            int countNotification = db.countNotifications(user_email);
        ...
        <div class="container">
            <div class="row" style="min-height: 600px;" >
                ...
                <div class="col-md-8">
                    ...
                    <div class="alert alert-warning mdl-shadow--2dp" id="alert_status" style="margin-top: 50px;">A confirmation email was sent to <strong><%=user_.getUserEmail()%></strong>. Please verify your account!</div>
        ...
        <%} else {
            ...
            //get map coordinates
            double lat_ = db.getLat(email, "expert");
            double lng_ = db.getLng(email, "expert");
            String addr_ = db.getAddr(email, "expert");
