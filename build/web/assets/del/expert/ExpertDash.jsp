...
//            int countNotification = DB.countNotifications(user_name);
        ...
        <header>
            ...
            <div class="nav-two navbar">
                <div class="container">
                    <ul class="nav navbar-nav">
                        <li class="active" ><a href="ExpertDash.jsp"  class="mdl-shadow--6dp" style="border: 1px solid #ddd;border-bottom-color: transparent;">System Dashboard</a></li>
                                        ...
                                        <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--4dp item" style="border-top: 1px solid rgba(0, 0, 0, 0.1);">
                                            <div class="mdl-card mdl-cell mdl-cell--12-col-desktop mdl-cell--9-col-tablet mdl-cell--4-col-phone">
                                                ...
                                                <div class="mdl-card__actions">
                                                    <a href="ViewPost.jsp?post_id=${post.post_id}" style="margin-left: 600px;"class="mdl-button">View More >>> </a>
                                                </div>
                                            </div>
                                        </section>
                                    </c:forEach>
